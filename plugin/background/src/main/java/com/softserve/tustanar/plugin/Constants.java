...
public final class Constants {
    ...
    public static final int LOCATION_INTERVAL = 5_000; // in milliseconds
    public static final float LOCATION_DISTANCE = 5f; // in metres

    public static int COOLDOWN_INTERVAL; // in milliseconds
    public static float COOLDOWN_DISTANCE; // in metres
    public static float NOTIFICATION_DISTANCE; // in metres
    public static float ACCEPTABLE_ACCURACY; // in metres
