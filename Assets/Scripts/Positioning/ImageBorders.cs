...
namespace TustanAR.Positioning{
    ...
    public interface IImageBorders{
        Location leftUpper { get; }
        Location rightBottom { get; }
    }

    public class ImageBorders: IImageBorders{
        public Location leftUpper { get; private set; }
        public Location rightBottom { get; private set; }

        public ImageBorders(Location _leftUpper, Location _rightBottom){
